/* -------------------------------------------------------------------------- *
 *                         OpenSim:  MainMillardvsOwnMuscle.cpp               *
 * -------------------------------------------------------------------------- *
...
#include "RockenfellerMuscle.cpp"
...
int main()
{
    ...
    try {
        ...
        // original muscle model (Millard2012EquilibriumMuscle)
        Millard2012EquilibriumMuscle* original =
                new Millard2012EquilibriumMuscle("original", maxIsometricForce,
        ...
        RockenfellerMuscle* Rockenfeller =
                new RockenfellerMuscle("Rockenfeller",
            maxIsometricForce, optimalFiberLength, tendonSlackLength, 
            pennationAngle, default_gamma, time_constant_hatze, nue, roh_0, 
