#ifndef OPENSIM_RockenfellerActivationDynamic_H_
#define OPENSIM_RockenfellerActivationDynamic_H_
/* -------------------------------------------------------------------------- *
 *             OpenSim:  RockenfellerActivationDynamic.h       *
 * -------------------------------------------------------------------------- *
*/
...
namespace OpenSim {
class OSIMACTUATORS_API RockenfellerActivationDynamic : public ModelComponent{
OpenSim_DECLARE_CONCRETE_OBJECT(RockenfellerActivationDynamic, ModelComponent);
public:
...
#endif //OPENSIM_RockenfellerActivationDynamic_H_
