/* -------------------------------------------------------------------------- *
 *            OpenSim:  RockenfellerActivationDynamic.cpp            *
 * -------------------------------------------------------------------------- *
*/
#include "RockenfellerActivationDynamic.h"
...
// CONSTRUCTION
//==============================================================================
RockenfellerActivationDynamic::RockenfellerActivationDynamic()
{
    setNull();
    constructProperties();
    setName("default_RockenfellerActivationDynamic");
}

RockenfellerActivationDynamic::
RockenfellerActivationDynamic(double time_constant_hatze,
                                            double nue,
                                            double roh_0,
                                            double gamma_C,
...
void RockenfellerActivationDynamic::setNull()
{
    setAuthors("Mike Spahr");
}

void RockenfellerActivationDynamic::constructProperties()
{
...
// SERVICES
//==============================================================================
double RockenfellerActivationDynamic::
...
// COMPONENT INTERFACE
//==============================================================================
void RockenfellerActivationDynamic::extendFinalizeFromProperties()
{
    Super::extendFinalizeFromProperties();

    std::string errorLocation = getName() + 
        " RockenfellerActivationDynamic::extendFinalizeFromProperties";
