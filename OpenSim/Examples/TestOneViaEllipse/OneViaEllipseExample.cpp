...
int main() {
    ...
    SimTK::Vec3 xyz_body_rotation(
            45.0 * SimTK::Pi / 180.0, 0, 90.0 * SimTK::Pi / 180.0);
    ...
    firstEllipse->set_xyz_body_rotation(xyz_body_rotation);
    ...
    reporter->addToReport(firstEllipse->getOutput("deflectionPointX"));
    reporter->addToReport(firstEllipse->getOutput("deflectionPointY"));
    reporter->addToReport(firstEllipse->getOutput("deflectionPointZ"));
