...
int main()
{
    ...
    try {
        ...
        RockenfellerMillardMuscle* Rockenfeller = new RockenfellerMillardMuscle("Rockenfeller",
            maxIsometricForce, optimalFiberLength, tendonSlackLength, 
            pennationAngle, time_constant_hatze, nue, roh_0, gamma_C);
        ...
        // Activation
        Rockenfeller->setDefaultActivation(0.01);
