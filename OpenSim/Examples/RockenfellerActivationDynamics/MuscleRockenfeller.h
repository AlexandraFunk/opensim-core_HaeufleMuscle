#ifndef OPENSIM_MUSCLE_ROCKENFELLER_H_
#define OPENSIM_MUSCLE_ROCKENFELLER_H_
/* -------------------------------------------------------------------------- *
 *                        OpenSim:  MuscleRockenfeller.h                         *
 * -------------------------------------------------------------------------- *
 ...
 * @see Muscle
 */
class MuscleRockenfeller : public Millard2012EquilibriumMuscle {
OpenSim_DECLARE_CONCRETE_OBJECT(MuscleRockenfeller, 
...
//=============================================================================
    ...
    OpenSim_DECLARE_PROPERTY(gamma_C, double,
        "Hatze Coefficient"); // TODO add description, is this necessary?
...
//=============================================================================
    ...
    //-------------------------------------------------------------------------
    MuscleRockenfeller();
    MuscleRockenfeller(const std::string &name, double maxIsometricForce, 
