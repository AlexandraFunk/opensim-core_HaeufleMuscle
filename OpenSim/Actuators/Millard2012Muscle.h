#ifndef OPENSIM_Millard2012Muscle_h__
#define OPENSIM_Millard2012Muscle_h__
...
class OSIMACTUATORS_API Millard2012Muscle : public Muscle {
OpenSim_DECLARE_CONCRETE_OBJECT(Millard2012Muscle, Muscle);
public:
//==============================================================================
// PROPERTIES
//==============================================================================
...
//==============================================================================
    ...
    Millard2012Muscle(const  std::string &aName,
...
//==============================================================================
    ...
    /** @returns The MuscleFirstOrderActivationDynamicModel2 owned by this
    model. */
    const MuscleFirstOrderActivationDynamicModel2& getActivationModel() const;
...
//==============================================================================
    ...
    MemberSubcomponentIndex actMdlIdx{
      constructSubcomponent<MuscleFirstOrderActivationDynamicModel2>("actMdl") };
...
#endif // OPENSIM_Millard2012Muscle_h__
